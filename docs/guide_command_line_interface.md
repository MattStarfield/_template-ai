# <img src="/img/assets/cli_icon.png" alt="cli_icon.png " width="30"> Guide: Command Line Interface (CLI)

| [Commands](#Commands) | [Serial Terminal Setup](#Serial-Terminal-Setup) |
...
### <img src="/img/assets/arduino_icon.png" alt="arduino_icon.png" width="20"> Arduino IDE Serial Monitor
...
1. Download and install the <img src="/img/assets/arduino_icon.png" alt="arduino_icon.png" width="15"> [Arduino IDE](https://www.arduino.cc/en/software) (if you haven't already)
1. Connect the target device to the PC with a USB cable
1. Open <img src="/img/assets/arduino_icon.png" alt="arduino_icon.png" width="15"> Arduino IDE
1. Go to `Tools > Port` and make sure the target device **COM Port** is selected<br>
    In this example, `COM6`<br>
    <img src="/img/assets/arduino_ide_com_port.png" alt="arduino_ide_com_port.png" width="400">
1. Click the <img src="/img/assets/arduino_serial_monitor_icon.png" alt="arduino_serial_monitor_icon.png" width="15"> **Serial Monitor** button in the toolbar <br>
    <img src="/img/assets/arduino_ide_toolbar_serial_monitor.png" alt="arduino_ide_toolbar_serial_monitor.png" width="400">
1. Set `baud` to match `SERIAL_BAUD_RATE` from `app_config.h`<br>
    <img src="/img/assets/arduino_ide_serial_baud.png" alt="arduino_ide_serial_baud.png" width="400">
1. Type `help` and click `Send`<br>
    ...
    <img src="/img/assets/arduino_ide_serial_help.png" alt="arduino_ide_serial_help.png" width="600">

### <img src="/img/assets/realterm_icon.png" alt="realterm_icon.png" width="20"> RealTerm
...
#### Setup
1. Download and install the latest version of <img src="/img/assets/realterm_icon.png" alt="realterm_icon.png" width="15"> [RealTerm v3+ ](https://realterm.i2cchip.com/)
1. Connect the target device to the PC with a USB cable
1. Open <img src="/img/assets/realterm_icon.png" alt="realterm_icon.png" width="15"> RealTerm
1. In the **Port** tab:
    ...
    * Click **`Open`** _twice_ to refresh the port settings
    ...
    <img src="/img/assets/realterm_port_tab.png" alt="realterm_port_tab.png" width="600">
1. In the **Display** tab, under **Display As**:
    * **Uncheck** the box for _Clear Terminal when Display Changes_
    * Select **Ascii plain**<br>

    <img src="/img/assets/realterm_display_tab.png" alt="realterm_display_tab.png" width="600">
