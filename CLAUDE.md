...
<!-- INIT-PROJECT:BEGIN durable-resources (managed block — regenerated by /init-project; do not hand-edit; OMIT entirely on empty/sparse repos with no knowledge base yet) -->
## 📚 Durable Project Knowledge

<!-- /init-project fills this in AFTER building claudedocs/init-project/. List the resources that exist + a freshness stamp. Example:
- **`claudedocs/init-project/MANIFEST.md`** — index of all durable resources + freshness. Read first.
- **`claudedocs/init-project/danger-map.md`** — high-stakes code; read before risky edits.
- `claudedocs/init-project/deep-dives/` — subsystem deep-dives.
- `claudedocs/init-project/{glossary,open-questions,hygiene-audit}.md`
- `.serena/memories/` — semantic layer when the Serena MCP is active.
Last init: <date> @ <commit>. Refresh: re-run /init-project.
-->
<!-- INIT-PROJECT:END durable-resources -->
