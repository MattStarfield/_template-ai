        ...
        if(          (inputStr == F("n"))
          ...
          )
          {
            deviceMode = DEVELOPMENT_MODE;
                  ...
                  //|| (inputStr == F("test"))
                  //|| (inputStr == F("5"))
                  //|| (inputStr == F("TESTING_MODE"))
          )
          {
            deviceMode = TESTING_MODE;
          }
    ...
    //=========================================================================//
     ...
     //----------------------------------------------------------------------------
      ...
      //----------------------------------------------------------------------------
        ...
        cmdSet.addPositionalArgument("debug/Level,dbg,dl", "default");     // ("argName, argAlias", "defaultValue");
      ...
      //----------------------------------------------------------------------------
        ...
        //----------------------------------------------------------------------------
            ...
            )
          {
            ...
            fanSpeedPWM = map(potValAvg, POT_TOLERANCE, (1023-POT_TOLERANCE), FAN_PWM_MIN, FAN_PWM_MAX);   // map potVal range to fanSpeedPWM range

            //Debug.print(DBG_DEBUG,    F("\n\r[D] potValAvg: %d"), potValAvg );
            Debug.print(DBG_DEBUG,    F("\n\r[D] fanSpeedPWM: %d"), fanSpeedPWM );
